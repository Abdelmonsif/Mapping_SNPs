...
def getArgs():
    ...
    parser.add_argument('-folderPath',
                        default='~/Downloads/Mapping_SNPs-master/',
                        required=False,
                        help='the path of folder')
    parser.add_argument('-inputCSV',
                        default='~/Downloads/Mapping_SNPs-master/SNPs_with_crystal_structure',
                        required=True,
                        help='the lst of input')
    parser.add_argument('-out',
                        default='~/Downloads/Mapping_SNPs-master/pdb_aligning_results',
                        required=True,
                        help='the folder of output')

    parser.add_argument('-pdb',
                        default='~/Downloads/Mapping_SNPs-master/pdb_only/',
                        required=False,
